...
void parallel_for_3x3_matOps(DType* matsFlatten, int numMats, Func func) {
...
template <typename DType>
void multiplicateMatrixOnDevice(DType* array_A, DType* array_B, DType* array_C, int M_p, int K_p, int N_p)
{
