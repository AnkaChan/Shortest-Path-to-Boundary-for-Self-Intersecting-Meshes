...
namespace SP {
	...
	public:
		...
		TriData(IdType* fVIds, const TVerticesMat& verts) {
	...
	public:
		...
		bool Intersect(IdType fVId1, IdType fVId2, IdType* fVIds1, IdType* fVIds2, const TVerticesMat & verts1, const TVerticesMat& verts2);
